...
<form name="regform" method="post" action="<?php echo "updateval.php?val=$row[0]";?>"  id="Form1" onsubmit="return Validateregform(this)">
...
<select name="title"  tabindex=1 size="1" id="Combobox1" style="position:absolute;left:209px;top:40px;width:200px;height:25px;z-index:1;">
<?php 
if ($row[1]=='mr')
...
<input type="text"  tabindex=2 id="Editbox1" style="position:absolute;left:209px;top:70px;width:198px;height:23px;line-height:23px;z-index:3;" name="surname" value="<?php echo"$row[2]"; ?>">
...
<input type="text"  tabindex=3 id="Editbox2" style="position:absolute;left:209px;top:100px;width:198px;height:23px;line-height:23px;z-index:5;" name="firstname" value="<?php echo"$row[3]"; ?>">
...
<input type="text"  tabindex=4 id="Editbox3" style="position:absolute;left:209px;top:130px;width:198px;height:23px;line-height:23px;z-index:7;" name="middlename" value="<?php echo"$row[4]"; ?>">
...
<select name="gender"  tabindex=5 size="1" id="Combobox2" style="position:absolute;left:209px;top:160px;width:200px;height:25px;z-index:9;">
<?php 
if ($row[5]=='male')
...
<input type="text"  tabindex=6 id="Editbox4" style="position:absolute;left:209px;top:190px;width:198px;height:23px;line-height:23px;z-index:11;" name="fathername" value="<?php echo"$row[6]"; ?>">
...
<input type="text"  tabindex=7 id="Editbox5" style="position:absolute;left:209px;top:220px;width:198px;height:23px;line-height:23px;z-index:13;" name="mothername" value="<?php echo"$row[7]"; ?>">
...
<input type="text"  tabindex=8 id="Editbox6" style="position:absolute;left:209px;top:250px;width:198px;height:23px;line-height:23px;z-index:15;" name="dob" value="<?php echo"$row[8]"; ?>">
...
<textarea name="address"  tabindex=9  id="TextArea1" style="position:absolute;left:209px;top:280px;width:198px;height:98px;z-index:17;" rows="5" cols="27"><?php echo"$row[9]"; ?></textarea>
...
<input type="text"  tabindex=10  tabindex=10  id="Editbox7" style="position:absolute;left:209px;top:385px;width:198px;height:23px;line-height:23px;z-index:19;" name="postalcode" value="<?php echo"$row[10]"; ?>">
...
<input type="text"  tabindex=11  id="Editbox8" style="position:absolute;left:209px;top:415px;width:198px;height:23px;line-height:23px;z-index:21;" name="city" value="<?php echo"$row[11]"; ?>">
...
<input type="text"  tabindex=12 id="Editbox9" style="position:absolute;left:209px;top:445px;width:198px;height:23px;line-height:23px;z-index:23;" name="state" value="<?php echo"$row[12]"; ?>">
...
<input type="text"  tabindex=13 id="Editbox10" style="position:absolute;left:209px;top:475px;width:198px;height:23px;line-height:23px;z-index:25;" name="religion" value="<?php echo"$row[13]"; ?>">
...
<input type="text" tabindex=14  id="Editbox11" style="position:absolute;left:209px;top:505px;width:198px;height:23px;line-height:23px;z-index:27;" name="caste" value="<?php echo"$row[14]"; ?>">
<div id="wb_Text16" style="position:absolute;left:10px;top:535px;width:189px;height:16px;z-index:28;">
...
<select name="lti"  tabindex=16 size="1" id="Combobox3" style="position:absolute;left:209px;top:565px;width:200px;height:25px;z-index:31;">
<?php 
if ($row[16]=='yes')
...
<input type="text"  tabindex=17 id="Editbox12" style="position:absolute;left:209px;top:594px;width:198px;height:23px;line-height:23px;z-index:33;" name="fred" value="<?php echo"$row[17]"; ?>">
...
<input type="text" tabindex=18  id="Editbox13" style="position:absolute;left:209px;top:625px;width:198px;height:23px;line-height:23px;z-index:35;" name="frjd" value="<?php echo"$row[18]"; ?>">
...
<input type="text"  tabindex=19  id="Editbox14" style="position:absolute;left:209px;top:655px;width:198px;height:23px;line-height:23px;z-index:37;" name="adhaar" value="<?php echo"$row[19]"; ?>">
...
<input type="text" tabindex=20  id="Editbox15" style="position:absolute;left:209px;top:685px;width:198px;height:23px;line-height:23px;z-index:39;" name="pan" value="<?php echo"$row[20]"; ?>">
...
<input type="text" tabindex=21 id="Editbox16" style="position:absolute;left:209px;top:715px;width:198px;height:23px;line-height:23px;z-index:41;" name="std" value="<?php echo"$row[21]"; ?>">
...
<input type="text" tabindex=22  id="Editbox17" style="position:absolute;left:209px;top:745px;width:198px;height:23px;line-height:23px;z-index:43;" name="landline" value="<?php echo"$row[22]"; ?>">
...
<input type="text"  tabindex=23 id="Editbox18" style="position:absolute;left:209px;top:775px;width:198px;height:23px;line-height:23px;z-index:45;" name="mobile" value="<?php echo"$row[23]"; ?>">
...
<input type="text" tabindex=24  id="Editbox19" style="position:absolute;left:209px;top:805px;width:198px;height:23px;line-height:23px;z-index:47;" name="email" value="<?php echo"$row[24]"; ?>">
...
<input type="text" tabindex=25  id="Editbox20" style="position:absolute;left:209px;top:835px;width:198px;height:23px;line-height:23px;z-index:49;" name="fax" value="<?php echo"$row[25]"; ?>">
...
<select name="designation" tabindex=26  size="1" id="Combobox4" style="position:absolute;left:209px;top:890px;width:200px;height:25px;z-index:52;">
...
<select name="appointmenttype" tabindex=27  size="1" id="Combobox5" style="position:absolute;left:209px;top:920px;width:200px;height:25px;z-index:54;">
...
<select name="programme" tabindex=28  size="1" id="Combobox6" style="position:absolute;left:209px;top:950px;width:200px;height:25px;z-index:56;">
...
<select name="course" size="1"  tabindex=29 id="Combobox7" style="position:absolute;left:209px;top:980px;width:202px;height:23px;z-index:58;">
<?php
if ($row[29]=='cse')
{
echo"
...
<select name="ftorpt" size="1"  tabindex=30 id="Combobox8" style="position:absolute;left:209px;top:1012px;width:200px;height:25px;z-index:60;">
<?php 
if ($row[31]=='ft')
...
<input type="text" id="Editbox21" tabindex=31 style="position:absolute;left:209px;top:1041px;width:198px;height:23px;line-height:23px;z-index:62;" name="da" value="<?php echo "$row[30]"; ?>">
...
<input type="text" id="Editbox22" tabindex=32 style="position:absolute;left:209px;top:1160px;width:198px;height:23px;line-height:23px;z-index:64;" name="doj" value="<?php echo "$row[32]"; ?>">
...
<input type="text" id="Editbox23" tabindex=33  style="position:absolute;left:208px;top:1190px;width:198px;height:23px;line-height:23px;z-index:66;" name="hra" value="<?php echo "$row[33]"; ?>">
...
<input type="text" id="Editbox24" tabindex=34 style="position:absolute;left:209px;top:1220px;width:198px;height:23px;line-height:23px;z-index:68;" name="gross" value="<?php echo "$row[34]"; ?>" autocomplete="on">
...
<input type="text" id="Editbox33"  tabindex=35 style="position:absolute;left:210px;top:1252px;width:197px;height:19px;line-height:19px;z-index:91;" name="payscale" value="<?php echo "$row[35]"; ?>" autocomplete="on">
...
<input type="text" id="Editbox25" tabindex=36 style="position:absolute;left:209px;top:1280px;width:198px;height:23px;line-height:23px;z-index:71;" name="pf" value="<?php echo "$row[36]"; ?>" autocomplete="on">
...
<input type="text" id="Editbox26" tabindex=37 style="position:absolute;left:209px;top:1310px;width:198px;height:23px;line-height:23px;z-index:73;" name="basic" value="<?php echo "$row[62]"; ?>" autocomplete="on">
...
<input type="text" id="Editbox27"  tabindex=38  style="position:absolute;left:208px;top:1341px;width:198px;height:23px;line-height:23px;z-index:75;" name="allowance" value="<?php echo "$row[37]"; ?>" autocomplete="on">
...
<select name="qual1" size="1"  tabindex=39 id="Combobox13" style="position:absolute;left:213px;top:1419px;width:200px;height:25px;z-index:78;">
<?php 
if ($row[38]=='phd')
...
<input type="text" id="Editbox29"  tabindex=57  style="position:absolute;left:215px;top:1866px;width:198px;height:23px;line-height:23px;z-index:81;" name="te" value="<?php echo "$row[56]"; ?>">
...
<input type="text" tabindex=58  id="Editbox30" style="position:absolute;left:216px;top:1902px;width:198px;height:23px;line-height:23px;z-index:83;" name="tte" value="<?php echo "$row[57]"; ?>">
<input type="text" id="Editbox31" tabindex=59 style="position:absolute;left:215px;top:1944px;width:198px;height:23px;line-height:23px;z-index:84;" name="re" value="<?php echo "$row[58]"; ?>">
...
<input type="text" id="Editbox32" tabindex=60  style="position:absolute;left:220px;top:2031px;width:198px;height:23px;line-height:23px;z-index:87;" name="bankac" value="<?php echo "$row[59]"; ?>">
...
<textarea name="patents" id="TextArea2"  tabindex=61 style="position:absolute;left:224px;top:2071px;width:198px;height:98px;z-index:89;" rows="5" cols="27"><?php echo "$row[60]"; ?></textarea>
<select name="isph" size="1" id="Combobox17"  tabindex=62 style="position:absolute;left:223px;top:2186px;width:200px;height:25px;z-index:90;">
<?php 
if ($row[61]=='yes')
{echo "<option value='yes' selected='selected'>yes</option>   <option value='no'>no</option> ";}
if ($row[61]=='no')
...
<input type="text" id="Editbox34"  tabindex=40 style="position:absolute;left:125px;top:1455px;width:42px;height:18px;line-height:18px;z-index:93;" name="yopq1" value="<?php echo "$row[39]"; ?>">
<input type="text" id="Editbox35"   tabindex=41 style="position:absolute;left:265px;top:1456px;width:43px;height:18px;line-height:18px;z-index:94;" name="pomq1" value="<?php echo "$row[40]"; ?>">
...
<input type="text" id="Editbox39"   tabindex=44 style="position:absolute;left:427px;top:1493px;width:143px;height:18px;line-height:18px;z-index:96;" name="nouq1" value="<?php echo "$row[43]"; ?>">
<input type="text" id="Editbox37"  tabindex=43  style="position:absolute;left:126px;top:1495px;width:127px;height:18px;line-height:18px;z-index:97;" name="noiq1" value="<?php echo "$row[42]"; ?>">
<input type="submit" tabindex=63  name="" value="submit" style="position:absolute;left:116px;top:2240px;width:150px;height:34px;z-index:98;"><div style="text-align:center"><span style="color:#000000;font-family:Arial;font-size:13px">Submit</span></div></button>
...
<span style="color:#000000;font-family:Arial;font-size:13px;">Year of passing: </span></div>
<input type="text" id="Editbox28"  tabindex=46 style="position:absolute;left:124px;top:1576px;width:42px;height:18px;line-height:18px;z-index:105;" name="yopq2" value="<?php echo "$row[45]"; ?>">
<div id="wb_Text46" style="position:absolute;left:187px;top:1580px;width:78px;height:16px;z-index:106;">
<span style="color:#000000;font-family:Arial;font-size:13px;">%of marks : </span></div>
<input type="text" id="Editbox36"   tabindex=47 style="position:absolute;left:264px;top:1577px;width:43px;height:18px;line-height:18px;z-index:107;" name="pomq2" value="<?php echo "$row[46]"; ?>">
...
<span style="color:#000000;font-family:Arial;font-size:13px;">Year of passing: </span></div>
<input type="text" id="Editbox43"  tabindex=52  style="position:absolute;left:129px;top:1705px;width:42px;height:18px;line-height:18px;z-index:113;" name="yopq3" value="<?php echo "$row[51]"; ?>">
<div id="wb_Text64" style="position:absolute;left:191px;top:1709px;width:78px;height:16px;z-index:114;">
<span style="color:#000000;font-family:Arial;font-size:13px;">%of marks : </span></div>
<input type="text" id="Editbox44"   tabindex=53 style="position:absolute;left:268px;top:1706px;width:43px;height:18px;line-height:18px;z-index:115;" name="pomq3" value="<?php echo "$row[52]"; ?>">
...
<span style="color:#000000;font-family:Arial;font-size:13px;">Name of Institute :</span></div>
<select name="mosq1" size="1"   tabindex=42  id="Combobox11" style="position:absolute;left:436px;top:1456px;width:96px;height:21px;z-index:119;">
<?php 
if ($row[41]=='fulltime')
{echo "<option value='fulltime' selected='selected'>fulltime</option>   <option value='distance'>distance</option> ";}
if ($row[41]=='distance')
{echo "<option value='distance' selected='selected'>distance</option>   <option value='fulltime'>fulltime</option> ";}
?>
</select>
<select name="qual2" size="1"  tabindex=45 id="Combobox9" style="position:absolute;left:214px;top:1538px;width:200px;height:25px;z-index:120;">
<?php 
if ($row[44]=='phd')
{echo "<option value='phd' selected='selected'>PHD</option>   <option value='mtech'>Mtech</option><option value='ms'>M.S</option> ";
}
...
<select name="qual3" size="1"   tabindex=51 id="Combobox10" style="position:absolute;left:218px;top:1665px;width:200px;height:25px;z-index:121;">
<?php 
if ($row[50]=='phd')
{echo "<option value='phd' selected='selected'>PHD</option>   <option value='mtech'>Mtech</option><option value='ms'>M.S</option> ";
}
...
<select name="mosq2"  tabindex=48 size="1" id="Combobox12" style="position:absolute;left:441px;top:1577px;width:96px;height:21px;z-index:122;">
<?php 
if ($row[47]=='fulltime')
{echo "<option value='fulltime' selected='selected'>fulltime</option>   <option value='distance'>distance</option> ";}
if ($row[47]=='distance')
{echo "<option value='distance' selected='selected'>distance</option>   <option value='fulltime'>fulltime</option> ";}
?></select>
<select name="mosq3" size="1"  tabindex=54 id="Combobox14" style="position:absolute;left:441px;top:1705px;width:96px;height:21px;z-index:123;">
<?php 
if ($row[53]=='fulltime')
{echo "<option value='fulltime' selected='selected'>fulltime</option>   <option value='distance'>distance</option> ";}
if ($row[53]=='distance')
...
<input type="text" id="Editbox38"  tabindex=49  style="position:absolute;left:130px;top:1613px;width:127px;height:18px;line-height:18px;z-index:124;" name="noiq2" value="<?php echo "$row[48]"; ?>">
<input type="text" id="Editbox40"  tabindex=55  style="position:absolute;left:132px;top:1744px;width:127px;height:18px;line-height:18px;z-index:125;" name="noiq3" value="<?php echo "$row[54]"; ?>">
<input type="text" id="Editbox41"   tabindex=50 style="position:absolute;left:433px;top:1615px;width:143px;height:18px;line-height:18px;z-index:126;" name="nouq2" value="<?php echo "$row[49]"; ?>">
<input type="text" id="Editbox42"   tabindex=56 style="position:absolute;left:435px;top:1742px;width:143px;height:18px;line-height:18px;z-index:127;" name="nouq3" value="<?php echo "$row[55]"; ?>">
